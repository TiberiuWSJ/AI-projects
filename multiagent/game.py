...
class Configuration:
    ...
    def generateSuccessorS(self, vector):
        """
        Generates a new configuration reached by translating the current
        configuration by the action vector.  This is a low-level call and does
        not attempt to respect the legality of the movement.
        ...
        Actions are movement vectors.
        """
        def has_decimal_point_five(number):
        ...
        if has_decimal_point_five(x + dx) and has_decimal_point_five(y + dy):
            return Configuration((x + dx + 0.5, y + dy + 0.5), direction)
        elif has_decimal_point_five(x + dx):
            return Configuration((x + dx + 0.5, y + dy), direction)
        elif has_decimal_point_five(y + dy):
...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            ...
            self.water = prevState.water.shallowCopy()
    ...
    def deepCopy(self):
        ...
        state.water = self.water.deepCopy()
